...
#y su precio y añadir el par al diccionario, hasta que el usuario decida terminar. Después se debe mostrar por pantalla la lista 
...
while continuar:
    ...
    cesta[item] = precio
    continuar = input('Quieres seguir (Si/No): ') == "Si"
coste = 0
